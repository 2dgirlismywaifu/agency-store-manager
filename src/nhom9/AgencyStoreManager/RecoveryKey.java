 ...
 * @author honkaiwaifu
 */
public final class RecoveryKey extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
         try {
            ...
            rs = ps.executeQuery();
            if (rs.next()) {
                RecoveryField.setText(rs.getString(4));
            }
            
        } catch (SQLException ex) {
                Logger.getLogger(RecoveryKey.class.getName()).log(Level.SEVERE, null, ex);
            }
